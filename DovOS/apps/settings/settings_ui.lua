...
local CACHE = "__dovos_settings_factory"
...
if not factory then
  ...
  return function(win)
    ...
    if cat == "system" then
      ...
      ln("")
      ln("DovOS desktop — taskbar, Start, windows.")
    ...
    elseif cat == "apps" then
      ...
      ln("")
      ln("System apps: /home/dovos (Dev mode).")
    elseif cat == "developer" then
      hdr("Developer")
      ln("")
      ln("Shows /home/dovos in Files.")
      ln("")
...
if _G.DovOS_APP and _G.DovOS_APP.id == "settings" then
