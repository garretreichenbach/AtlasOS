...
local CACHE = "__dovos_editor_factory"
...
if _G.DovOS_APP and _G.DovOS_APP.id == "editor" then
  local app = _G.DovOS_APP
  local path = app and app.args and app.args[1]
  if type(_G.DovOS_editor_open) == "function" then
    _G.DovOS_editor_open(path)
